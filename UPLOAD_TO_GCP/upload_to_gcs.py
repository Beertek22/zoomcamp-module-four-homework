...
def download_file(params):
    trip_type, year, month = params
    file_name = f"{trip_type}_tripdata_{year}-{month}.csv.gz"
...
if __name__ == "__main__":
    ...
    year_month_type_pairs = [
        (trip_type, year, month)
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        file_paths = list(executor.map(download_file, year_month_type_pairs))
